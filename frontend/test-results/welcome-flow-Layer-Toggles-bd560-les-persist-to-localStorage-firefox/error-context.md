...
- generic [active] [ref=e1]:
  ...
  - iframe [ref=e94]:
    - generic [ref=f1e1]:
      ...
      - generic [ref=f1e5]:
        - generic [ref=f1e6] [cursor=pointer]: ERROR in ./src/App.ts (/home/jcviau/.openclaw/workspace/voxyflow/frontend/src/App.ts) 426:9-18
        - generic [ref=f1e7]: "[tsl] ERROR in /home/jcviau/.openclaw/workspace/voxyflow/frontend/src/App.ts(426,10) TS2339: Property 'ideaBoard' does not exist on type 'App'."
```