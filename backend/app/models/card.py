...
class CardCreate(BaseModel):
    ...
    status: str = Field(default="backlog", pattern="^(backlog|todo|in-progress|done|archived)$")
...
class CardUpdate(BaseModel):
    ...
    status: Optional[str] = Field(None, pattern="^(backlog|todo|in-progress|done|archived)$")
